  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Google Colab",
        image:
          "https://th.bing.com/th/id/OIP.laYIzRY2A-jpnBA2rO2jSQAAAA?w=286&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7",
      },
    ],
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Vercel",
        image:
          "https://th.bing.com/th/id/OIP.ypz_d6GL7n2nXfQnbw_ARAHaFj?w=206&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7",
      },
      {
        name: "Figma",
        image:
...
export const experiences = [
  {
    id: 0,
    img: "https://res.cloudinary.com/dh4adw5o7/image/upload/v1727803425/Portfolio%20Content/qgxozuzapplo9prsw7sa.png",
    role: "SDE INTERN",
    company: "Scymes Services Pvt. Ltd.",
    date: "Sept 2024 - Present",
    desc: "•	Integrated Customer Relationship Management and Data Analytics Platform for Enhanced Customer Insights, Experience, and Administrative Efficiency in Banking Solutions. •	Developed a multi-user administrative system for Axis Bank, enhancing user control and implementing advanced customer management with intuitive data handling. •	Integrated financial software solutions offering seamless bank wallet functionality, transaction management, and customer interaction tracking for enhanced operational efficiency. •	Secure, scalable platform leveraging Svelte for UI, incorporating multi-user administration, RBAC, and ReBAC for comprehensive PocketBase SQL data management and user experience optimization.",
    skills: [
      "Svelte",
      "sveltekit",
      "PocketBase SQL",
...

  {
    ...
    desc: "•	Next.js Applications with LLM Chatbot Integration and Open-Source Contributions. •	Developed and deployed full-stack applications with Next.js, integrating LLM chatbots. •	Utilized Git for version control and coordinated with the team via Slack. •	Contributed to open-source projects in diverse domain, leveraging skills in AI and full-stack SWE.",
    skills: [
      "Next.js",
      "JavaScript",
      "React",
...

  {
    ...
    desc: "•	Created a Cross-Platform Agricultural Marketplace Boosting Farmer-Trader Interactions and Revenue Growth. •	Developed cross-platform applications using Flutter and Dart, enhancing user experience for iOS and Android platforms. •	Designed a full-stack web application for real-time crop trading, enabling seamless interactions between over 600 farmers and buyers. •	Deployed applications on Firebase and Google Cloud, achieving significant user engagement and revenue growth in agricultural commerce.",
    skills: [
      "Flutter",
      "Dart",
      "Firebase",
  ...
  {
    id: 0,
    img: "https://res.cloudinary.com/dh4adw5o7/image/upload/v1727804937/Portfolio%20Content/mdkchljjgpr8d6w7v49q.jpg",
    role: "Content Writer Intern",
    company: "Marpu Foundation",
    date: "Apr 2024 - Apr 2024",
    desc: "•	Strategic Content Development for Community Advocacy and Social Engagement Initiatives. •	Implemented SEO strategies that improved. •	website ranking and visibility. •	Created engaging social media content to enhance community awareness and participation. •	Developed and managed content for the organization's website, blog, and social media platforms.",
    skills: [
      "SEO",
      "Content Development",
      "Social Media",
  ...
  {
    id: 3,
    img: "https://res.cloudinary.com/dh4adw5o7/image/upload/v1727802607/Portfolio%20Content/u0pvbb3bm9cxzoxhss8u.jpg",
  ...
  {
    id: 1,
    img: "https://res.cloudinary.com/dh4adw5o7/image/upload/v1726436767/Portfolio%20Content/lkexm4mhhyfelgyanjte.png",
    role: "Web Developer Intern",
    company: "Bishwas Technology",
    date: "Feb 2024 - Mar 2024",
    desc: "•	Developed News Website with CRUD Functionality Using React, Firebase, and Google Cloud. •	Developed a news website with CRUD functionality using React, JavaScript, and Firebase. •	Implemented user roles for content management, enabling updates and deletions by admins only. •	Implemented user-specific news management features utilizing Firebase and Google Cloud Console.",
    skills: [
      "React Js",
      "Firebase",
      "Google Cloud",
  ...
  {
    id: 2,
    img: "https://res.cloudinary.com/dh4adw5o7/image/upload/v1727802705/Portfolio%20Content/essiwlwbxmpfcawut20n.jpg",
...
export const education = [
  {
    id: 0,
    img: "https://res.cloudinary.com/dh4adw5o7/image/upload/v1727801857/Portfolio%20Content/d08sr1wjw6apsowz1ws0.png",
